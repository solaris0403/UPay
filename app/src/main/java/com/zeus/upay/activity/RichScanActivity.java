...
import com.zeus.upay.capture.camera.CameraManager;
import com.zeus.upay.capture.decode.DecodeThread;
import com.zeus.upay.capture.utils.BeepManager;
import com.zeus.upay.capture.utils.CaptureActivityHandler;
import com.zeus.upay.capture.utils.InactivityTimer;
...
public class RichScanActivity extends BaseActivity implements SurfaceHolder.Callback{
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        startActivity(new Intent(this, CaptureResultActivity.class).putExtras(bundle));
    }
    ...
    protected void onResume() {
        ...
        // off screen.
        cameraManager = new CameraManager(getApplication(),scanPreview);
        handler = null;
